...
import 'package:tabpay_app/src/features/home/views/home_main.dart' as _i3;
import 'package:tabpay_app/src/features/intro/views/intro_main.dart' as _i4;
import 'package:tabpay_app/src/features/login/views/login_main.dart' as _i5;
...
import 'package:tabpay_app/src/features/login/views/login_verification.dart'
    as _i7;
import 'package:tabpay_app/tabpay_core/common/pages/numpad_page.dart' as _i1;
...
abstract class $AppRouter extends _i8.RootStackRouter {
  ...
  final Map<String, _i8.PageFactory> pagesMap = {
    ...
    HomeMainRoute.name: (routeData) {
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i3.HomeMainPage(),
      );
    },
    InstructionRoute.name: (routeData) {
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i4.InstructionPage(),
      );
    },
    LoginMainRoute.name: (routeData) {
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i5.LoginMainPage(),
      );
    },
    LoginRouteWrapper.name: (routeData) {
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i6.LoginRouteWrapper(),
      );
    },
    LoginVerificationRoute.name: (routeData) {
      ...
      return _i8.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i7.LoginVerificationPage(
          key: args.key,
